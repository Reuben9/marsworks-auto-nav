...
(cl:defmethod cl:initialize-instance :after ((m <Imu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Imu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name leo_msgs-msg:<Imu> is deprecated: use leo_msgs-msg:Imu instead.")))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <Imu>))
...
(cl:defmethod temperature-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader leo_msgs-msg:temperature-val is deprecated.  Use leo_msgs-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'gyro_x-val :lambda-list '(m))
(cl:defmethod gyro_x-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader leo_msgs-msg:gyro_x-val is deprecated.  Use leo_msgs-msg:gyro_x instead.")
  (gyro_x m))

(cl:ensure-generic-function 'gyro_y-val :lambda-list '(m))
(cl:defmethod gyro_y-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader leo_msgs-msg:gyro_y-val is deprecated.  Use leo_msgs-msg:gyro_y instead.")
  (gyro_y m))

(cl:ensure-generic-function 'gyro_z-val :lambda-list '(m))
(cl:defmethod gyro_z-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader leo_msgs-msg:gyro_z-val is deprecated.  Use leo_msgs-msg:gyro_z instead.")
  (gyro_z m))

(cl:ensure-generic-function 'accel_x-val :lambda-list '(m))
(cl:defmethod accel_x-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader leo_msgs-msg:accel_x-val is deprecated.  Use leo_msgs-msg:accel_x instead.")
  (accel_x m))

(cl:ensure-generic-function 'accel_y-val :lambda-list '(m))
(cl:defmethod accel_y-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader leo_msgs-msg:accel_y-val is deprecated.  Use leo_msgs-msg:accel_y instead.")
  (accel_y m))

(cl:ensure-generic-function 'accel_z-val :lambda-list '(m))
(cl:defmethod accel_z-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader leo_msgs-msg:accel_z-val is deprecated.  Use leo_msgs-msg:accel_z instead.")
  (accel_z m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Imu>)))
  ...
  "d8596af47cb860f11b5f9246dd06f4fc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Imu)))
  "Returns md5sum for a message object of type 'Imu"
  "d8596af47cb860f11b5f9246dd06f4fc")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Imu>)))
  ...
  (cl:format cl:nil "# This message holds the data retrieved from an Accel/Gyro+Temp IMU sensor~%#~%# The temperature field represents the temperature reported by the sensor in Degrees Celcius~%# The gyro_* fields represent the rotational velocity in rad/s~%# The accel_* fields represent the linear acceleration in m/s^2~%~%time stamp~%float32 temperature~%float32 gyro_x~%float32 gyro_y~%float32 gyro_z~%float32 accel_x~%float32 accel_y~%float32 accel_z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Imu)))
  "Returns full string definition for message of type 'Imu"
  (cl:format cl:nil "# This message holds the data retrieved from an Accel/Gyro+Temp IMU sensor~%#~%# The temperature field represents the temperature reported by the sensor in Degrees Celcius~%# The gyro_* fields represent the rotational velocity in rad/s~%# The accel_* fields represent the linear acceleration in m/s^2~%~%time stamp~%float32 temperature~%float32 gyro_x~%float32 gyro_y~%float32 gyro_z~%float32 accel_x~%float32 accel_y~%float32 accel_z~%~%~%"))
